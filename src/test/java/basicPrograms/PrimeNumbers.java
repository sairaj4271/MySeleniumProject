...
@Data
@Action(
  actionText = "Count non-empty cells in row number rowIndex from latest downloaded .xlsx file",
  description = "Counts non-empty cells in the given row from the most recent downloaded Excel (.xlsx) file",
  applicationType = ApplicationType.WEB
)
public class PrimeNumbers extends WebAction {
